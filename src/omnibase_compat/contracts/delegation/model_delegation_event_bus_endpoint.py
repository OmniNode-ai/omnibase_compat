...
# COMPAT_MIGRATION_TARGET: omnibase_core.contracts.delegation.model_delegation_event_bus_endpoint
...
class ModelDelegationEventBusEndpoint(BaseModel):
    ...
    provider: str = Field(..., description="Event bus provider identifier (e.g. redpanda, kafka)")
