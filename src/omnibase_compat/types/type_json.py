...
Usage:
    >>> from omnibase_compat.types.type_json import (
    ...     JsonPrimitive,
    ...     JsonType,
    ...     PrimitiveValue,
    ...     ToolParameterValue,
...
See Also:
    - omnibase_core.types.type_json: Maintains identical type definitions
      (not imported due to SDK boundary)
"""
...
#     ... }
type StrictJsonType = StrictJsonPrimitive | list[StrictJsonType] | dict[str, StrictJsonType]
