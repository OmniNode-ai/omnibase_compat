...
from omnibase_compat.contracts.pr_occ_stamp.model_pr_body_section import ModelPrBodySection
...
class TestModelPrBodySection:
    ...
    def test_serialization_roundtrip(self) -> None:
        section = ModelPrBodySection(heading="## Summary", content="body", is_stamp_section=False)
        assert ModelPrBodySection.model_validate(section.model_dump()) == section
        assert ModelPrBodySection.model_validate_json(section.model_dump_json()) == section
