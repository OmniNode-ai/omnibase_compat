...
class TestModelPrReceiptGateSkipToken:
    def test_valid_construction(self) -> None:
        token = ModelPrReceiptGateSkipToken(gate_name="receipt-gate", reason="docs only")
    ...
    def test_render_token_exact_format(self) -> None:
        token = ModelPrReceiptGateSkipToken(gate_name="deploy-gate", reason="correctness fix")
    ...
    def test_serialization_roundtrip(self) -> None:
        ...
        restored_json = ModelPrReceiptGateSkipToken.model_validate_json(token.model_dump_json())
